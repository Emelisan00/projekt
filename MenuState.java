/*
 * DETTA ÄR SPELETS MENY DÄR MAN KAN VÄLJA OLIKA VAL
 * MAN KAN SPELA ELLER AVSLUTA SPELET MED KLICK PÅ TANGENTBORDET OCH MAN KAN ÄVEN KOLLA SCORE MED MUSKLICK
 */
...
public class MenuState extends GameState {
	...
	public void keyPressed(KeyEvent key) {
		System.out.println("Trycker på " + key.getText() + " i MenyState");
